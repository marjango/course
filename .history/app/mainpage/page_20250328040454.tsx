    ...
    <>
      ...
      <section className={s.reviews}>
        ...
        <div className={s.reviewList}>
          ...
          <Image src={reviewer} alt="reviewer" className={s.reviewer1}/>
          <div className={s.reviewItem2}>
            <p>
          ...
          <Image src={reviewer} alt="reviewer" className={s.reviewer2}/>
          <div className={s.reviewItem3}>
            <p>
          ...
          <Image src={reviewer} alt="reviewer" className={s.reviewer3}/>
        </div>
      </section>
