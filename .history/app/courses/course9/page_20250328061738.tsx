        ...
        <div className={s.themes}>
          <div className={s.theme}>
            ...
            <ul>
              ...
              <li>
                Основные виды тестирования: ручное, автоматизированное,
                нагрузочное
              </li>
            </ul>
          </div>
          <div className={s.theme}>
            ...
            <ul>
              <li>Использование REST API и SQL-запросов в тестировании</li>
              <li>Автоматизация тестирования API с Postman и RestAssured</li>
            </ul>
          </div>
          <div className={s.theme}>
          ...
          <div className={s.theme}>
            ...
            <ul>
              <li>Тестирование мобильных приложений на Android и iOS</li>
          ...
          <div className={s.theme}>
            ...
            <ul>
              <li>Тестирование реального веб- или мобильного приложения</li>
