    ...
    <>
      <div className={s.coursePage}>
        ...
        <div className={s.hero}>
          <div className={s.text}>
            ...
            <p>
              Мобильные приложения стали ключевым инструментом для бизнеса,
              стартапов и пользователей по всему миру. В этом курсе вы освоите
              полный цикл разработки мобильных приложений — от идеи и дизайна до
              программирования и публикации в App Store и Google Play. Вы
              научитесь работать с нативными и кроссплатформенными технологиями,
              разрабатывать UI/UX, подключать API и базы данных, а также
              оптимизировать производительность приложений. Курс подойдет как
              новичкам, так и разработчикам, желающим углубить свои знания.
            </p>
          </div>
      ...
      <div className={s.target}>
        ...
        <div className={s.targetText}>
          ...
          <p>
            Курс подойдет начинающим и опытным разработчикам, дизайнерам,
            предпринимателям и всем, кто хочет создавать современные мобильные
            приложения. Он будет полезен тем, кто хочет запустить свой стартап,
            улучшить навыки программирования или освоить востребованную
            профессию мобильного разработчика. Также подойдет IT-специалистам,
            которые хотят перейти в сферу мобильной разработки.
          </p>
        </div>
      </div>
      <div className={s.schedule}>
        <h1>ПЛАН КУРСА</h1>
        <h3>
          Курс «Разработка мобильных приложений» состоит из 40 уроков и
          рассчитан на 10 недель
        </h3>
        <div className={s.themes}>
          <div className={s.theme}>
            ...
            <ul>
              ...
              <li>
                Различие между нативными и кроссплатформенными <br /> технологиями
              </li>
            </ul>
          </div>
          <div className={s.theme}>
          ...
          <div className={s.theme}>
            ...
            <ul>
              <li>Разработка полноценного мобильного приложения</li>
              <li>Презентация и запуск проекта</li>
            </ul>
          </div>
        </div>
