...
import s from "../course1/course.module.css";
    ...
    <>
      <div className={s.coursePage}>
        ...
        <div className={s.hero}>
          ...
          <Image src={img2} width={617} height={386} alt="course" />
        </div>
      </div>
      ...
      <div className={s.schedule}>
        ...
        <div className={s.themes}>
          ...
          <div className={s.theme}>
            ...
            <ul>
              <li>Разработка полнофункционального приложения</li>
              <li>Презентация проекта и финальная защита</li>
            </ul>
          </div>
        </div>
