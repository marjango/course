    ...
    <>
      <div className={s.coursePage}>
        ...
        <div className={s.hero}>
          <div className={s.text}>
            ...
            <p>
              Чат-боты и голосовые ассистенты становятся неотъемлемой частью
              бизнеса, помогая автоматизировать общение с клиентами и повышать
              уровень сервиса. В этом курсе вы изучите основные технологии и
              инструменты создания ботов, освоите работу с NLP (обработкой
              естественного языка) и научитесь интегрировать чат-ботов с
              популярными мессенджерами и голосовыми платформами. В результате
              вы сможете разрабатывать интеллектуальные боты для бизнеса,
              поддержки клиентов и автоматизации задач. 4o
            </p>
          </div>
      ...
      <div className={s.target}>
        ...
        <div className={s.targetText}>
          ...
          <p>
            Курс подойдет разработчикам, маркетологам, предпринимателям и всем,
            кто хочет создать умных виртуальных помощников. Он будет полезен
            специалистам по автоматизации, продуктовым менеджерам и тем, кто
            работает с клиентским сервисом и цифровыми платформами. Также
            подойдет начинающим программистам, желающим освоить технологии NLP и
            разработку голосовых интерфейсов.
          </p>
        </div>
      </div>
      <div className={s.schedule}>
        <h1>ПЛАН КУРСА</h1>
        <h3>
          Курс «Разработка чат-ботов и голосовых ассистентов» состоит из 35
          уроков и рассчитан на 9 недель.
        </h3>
        <div className={s.themes}>
          ...
          <div className={s.theme}>
            <p>Создание простого чат-бота</p>
            <ul>
              <li>Разработка базового бота на Python</li>
              <li>Работа с текстовыми командами и обработкой сообщений</li>
            </ul>
          </div>
          <div className={s.theme}>
            <p> Финальный проект</p>
            <ul>
              <li>Разработка и запуск интеллектуального чат-бота</li>
              <li>Презентация и тестирование решения</li>
            </ul>
          </div>
        </div>
