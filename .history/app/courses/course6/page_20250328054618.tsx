    ...
    <>
      <div className={s.coursePage}>
        ...
        <div className={s.hero}>
          <div className={s.text}>
            ...
            <p>
              Современные компании стремятся минимизировать ручной труд и
              повысить эффективность процессов. В этом курсе вы изучите
              технологии роботизированной автоматизации (RPA), научитесь
              анализировать бизнес-процессы, разрабатывать программных роботов и
              интегрировать их в корпоративные системы. Освоите инструменты
              UiPath, Power Automate и Python для создания автоматизированных
              решений, которые ускорят работу и снизят затраты бизнеса.
            </p>
          </div>
      ...
      <div className={s.target}>
        ...
        <div className={s.targetText}>
          ...
          <p>
            Курс подойдет бизнес-аналитикам, IT-специалистам, менеджерам и всем,
            кто хочет автоматизировать рутинные процессы. Он будет полезен тем,
            кто работает с большими объемами данных, повторяющимися задачами и
            хочет внедрять RPA-решения в компаниях. Подходит для начинающих
            разработчиков, специалистов по цифровой трансформации и тех, кто
            стремится повысить эффективность работы с помощью автоматизации.
          </p>
        </div>
      </div>
      <div className={s.schedule}>
        <h1>ПЛАН КУРСА</h1>
        <h3>
          Курс «Автоматизация бизнес-процессов (RPA)» состоит из 30 уроков и
        ...
        <div className={s.themes}>
          ...
          <div className={s.theme}>
            ...
            <ul>
              <li>Создание простых ботов для автоматизации офисных <br />задач</li>
              <li>Запись действий пользователя и управление ботами</li>
            </ul>
          </div>
          <div className={s.theme}>
            <p> Анализ и моделирование <br /> бизнес-процессов</p>
            <ul>
          ...
          <div className={s.theme}>
            ...
            <ul>
              ...
              <li>Управление несколькими ботами и распределение <br />задач</li>
            </ul>
          </div>
          <div className={s.theme}>
          ...
          <div className={s.theme}>
            ...
            <ul>
              <li>
                Разработка программного робота для реального бизнес-процесса
              </li>
