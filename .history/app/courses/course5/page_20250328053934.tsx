  ...
  return (
    <>
      ...
      <div className={s.schedule}>
        <h1>ПЛАН КУРСА</h1>
        <h3>
        Курс «Системное администрирование и облачные технологии» состоит из 40 уроков и рассчитан на 10 недель.
        </h3>
        <div className={s.themes}>
          <div className={s.theme}>
            ...
            <ul>
              ...
              <li>
              Основные компоненты серверных и облачных систем</li>
            </ul>
          </div>
          <div className={s.theme}>
