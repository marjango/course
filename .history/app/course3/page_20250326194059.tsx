  ...
  return (
    <>
      ...
      <div className={s.schedule}>
        <h1>ПЛАН КУРСА</h1>
        <h3>
        Курс «Искусственный интеллект и машинное <br/> обучение» состоит из 45 уроков и рассчитан на 12 недель.
        </h3>
        <div className={s.themes}>
          ...
          <div className={s.theme}>
            ...
            <ul>
              <li>Обучение с учителем: линейная и логистическая регрессия, деревья решений</li>
              <li>Обучение без учителя: кластеризация, метод главных компонент</li>
            </ul>
          </div>
          <div className={s.theme}>
