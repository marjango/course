        ...
        <div className={s.courses}>
          <Link href="/courses/course1/1">
            <div className={s.course}>
              <Image src={img1} width={415} height={235} alt="Автоматизация процессов и DevOps" layout="responsive"/>
              <p>Автоматизация <br /> процессов и DevOps</p>
            </div>
          </Link>
          <Link href="/courses/course2">
            <div className={s.course}>
              <Image src={img2} width={415} height={252} alt="Программирование и разработка ПО" layout="responsive" />
              <p>Программирование и разработка ПО</p>
            </div>
          </Link>
          <Link href="/courses/course3">
            <div className={s.course}>
              <Image src={img3} width={415} height={238} alt="Искусственный интеллект" layout="responsive"/>
              <p>Искусственный интеллект и машинное обучение</p>
            </div>
          </Link>
          <Link href="/courses/course4">
            <div className={s.course}>
              <Image src={img4} width={415} height={235} alt="Кибербезопасность" layout="responsive"/>
              <p>Кибербезопасность и защита данных</p>
            </div>
          </Link>
          <Link href="/courses/course5">
            <div className={s.course}>
              <Image src={img5} width={415} height={252} alt="Системное администрирование" layout="responsive"/>
              <p>Системное администрирование и облачные технологии</p>
            </div>
          </Link>
          <Link href="/courses/course6">
            <div className={s.course}>
              <Image src={img6} width={415} height={238} alt="Автоматизация бизнес-процессов" layout="responsive"/>
              <p>Автоматизация бизнес-процессов (RPA)</p>
            </div>
          </Link>
          <Link href="/courses/course7">
            <div className={s.course}>
              <Image src={img7} width={415} height={235} alt="Разработка чат-ботов" layout="responsive"/>
              <p>Разработка чат-ботов и голосовых ассистентов</p>
            </div>
          </Link>
          <Link href="/courses/course8">
            <div className={s.course}>
              <Image src={img8} width={415} height={252} alt="Разработка мобильных приложений" layout="responsive" />
              <p>Разработка мобильных приложений</p>
            </div>
          </Link>
          <Link href="/courses/course9">
            <div className={s.course}>
              <Image src={img9} width={415} height={238} alt="Тестирование ПО и автоматизация QA" layout="responsive" />
