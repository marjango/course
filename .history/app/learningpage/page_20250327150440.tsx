    ...
    <>
      ...
      <div className={s.descriptions}>
        ...
        <div className={s.description}>
          ...
          <br />
          <p> В случае возникновения трудностей студент может обратиться к куратору. Это позволяет оперативно решать технические и учебные проблемы, а также повышает уровень вовлеченности студентов в образовательный процесс.</p>
        </div>
      </div>
