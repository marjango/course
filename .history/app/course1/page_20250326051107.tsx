  ...
  return (
    <>
      <div className={s.coursePage}>
        ...
        <p>
          Этот курс познакомит вас с современными инструментами автоматизации,
          CI/CD-процессами, контейнеризацией и управлением инфраструктурой. Вы
          освоите Docker, Kubernetes, Ansible, Terraform и Jenkins, научитесь
          настраивать мониторинг, автоматизировать развертывание приложений и
          работать с облачными сервисами. Начните обучение и станьте
          специалистом, который делает IT-инфраструктуру стабильнее, быстрее и
          эффективнее!
        </p>
        </div>
        <Image src={imgage} width={617} height={386} alt="course" />
        </div>
      </div>
      <div className={s.target}>
        ...
        <p>
          ...
          стремящимся освоить контейнеризацию, CI/CD и облачные сервисы, а также
          QA-инженерам, желающим интегрировать автоматизированное тестирование в
          DevOps-процессы. IT-менеджеры смогут лучше понять, как автоматизация
          ускоряет разработку и повышает надежность систем, а начинающие
          IT-специалисты получат востребованные навыки для успешного старта
          карьеры в DevOps.
        </p>
      </div>
      <div className={s.schedule}>
        <h1>ПЛАН КУРСА</h1>
        <h3>
          Курс «Автоматизация процессов и DevOps» состоит из 35 уроков и
