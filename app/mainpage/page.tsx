        ...
        <div className={s.courses}>
          <Link href="/courses/course1">
            <div className={s.course}>
              <Image src={img1} width={415} height={235} alt="course" className={s.img1} />
              <p>
          ...
          <Link href="/courses/course2">
            <div className={s.course}>
              <Image src={img2} width={415} height={252} alt="course" className={s.img2} />
              <p>Программирование и разработка программного обеспечения</p>
            </div>
          </Link>
          <Link href="/courses/course6">
            <div className={s.course}>
              <Image src={img6} width={415} height={238} alt="course"  className={s.img3}/>
              <p>Автоматизация</p>
            </div>
          </Link>
        </div>
