    ...
    <>
      <div className={s.lesson}>
        ...
        <div className={s.hero}>
          <div className={s.text}>
            ...
            <p>
              Цель урока: Понять основные принципы DevOps, зачем он нужен, и
              какие инструменты используются для автоматизации процессов.
            </p>
          </div>
          <div className={s.video}>
            <Image src={video} alt="video" />
            <p className={s.videoTitle}>
              Как DevOps изменил IT: мнение профессора
            </p>
          </div>
        </div>
      </div>
      <div className={s.test}>
        ...
        <div className={s.question}>
          <p>
            Что такое DevOps и какие проблемы он решает в разработке
        ...
        <div className={s.question}>
          <p>
            В чем разница между традиционным процессом разработки и
            DevOps-подходом?
          </p>
          <input type="text" placeholder="Ответ" />
        </div>
        <div className={s.question}>
          <p>
            Какие инструменты чаще всего используются в DevOps и для чего они
            нужны?
          </p>
          <input type="text" placeholder="Ответ" />
        </div>
        <div className={s.question}>
          <p>
            Как DevOps влияет на скорость и качество выпуска программных
            продуктов?
          </p>
          <input type="text" placeholder="Ответ" />
        </div>
        ...
        <div className={s.homework}>
          ...
          <ul>
            <li>Прочитать статью «DevOps: от теории к практике»</li>
            <li>Установить Git и настроить локальное окружение</li>
            <li>Ответить на вопросы по теме в тесте</li>
          </ul>
        </div>
      </div>
